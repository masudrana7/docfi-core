...
**/
class DocfiTheme_Social_Widget extends WP_Widget {

	public function __construct() {
		$widget_ops = array(
			'classname' => 'rt_footer_social_widget',
			'description' => esc_html__( 'Docfi : (For Footer) Social Link widget with Description' , 'docfi-core' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'rt-about-social', esc_html__( 'Docfi : Social Widget' , 'docfi-core' ), $widget_ops );
	...
	public function form( $instance ){
		$defaults = array(
			'title'       => esc_html__( 'About Company' , 'docfi-core' ),
			'description' => '',
			'social_label'=> '',
			'facebook'    => '',
			'twitter'     => '',
		...
		$fields = array(
			...
			'facebook'     => array(
				'label'    => esc_html__( 'Facebook URL', 'docfi-core' ),
				'type'     => 'url',
				),
			'twitter'      => array(
				'label'    => esc_html__( 'Twitter URL', 'docfi-core' ),
				'type'     => 'url',
				),
			'linkedin'     => array(
				'label'    => esc_html__( 'LinkedIn URL', 'docfi-core' ),
				'type'     => 'url',
				),
			'pinterest'    => array(
				'label'    => esc_html__( 'Pinterest URL', 'docfi-core' ),
				'type'     => 'url',
				),
			'skype'        => array(
				'label'    => esc_html__( 'Skype URL', 'docfi-core' ),
				'type'     => 'url',
				),
			'youtube'      => array(
				'label'    => esc_html__( 'Youtube URL', 'docfi-core' ),
				'type'     => 'url',
				),
			'instagram'    => array(
				'label'    => esc_html__( 'Instagram URL', 'docfi-core' ),
				'type'     => 'url',
				),
			'behance'      => array(
				'label'    => esc_html__( 'Behance Plus URL', 'docfi-core' ),
				'type'     => 'url',
				),
			'dribbble'     => array(
				'label'    => esc_html__( 'Dribbble Plus URL', 'docfi-core' ),
				'type'     => 'url',
				),
			);
