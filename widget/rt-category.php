 ...
 * @version 1.0
 */
class DocfiTheme_Category_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => esc_html__( 'Docfi Category Widget' , 'docfi-core' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'rt-categories', __( 'Docfi: Categories' ), $widget_ops );
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'select_style' )); ?>"><?php esc_html_e( 'Select Category Style : ', 'docfi-core' ); ?></label>
			<select name="<?php echo esc_attr( $this->get_field_name( 'select_style' )); ?>">
				<option <?php if ( $select_style == 'category-style-1' ) {  echo 'selected'; } ?> value="category-style-1"><?php esc_html_e( 'Style 1' , 'docfi-core' ); ?></option>
				<option <?php if ( $select_style == 'category-style-2' ) {  echo 'selected'; } ?> value="category-style-2"><?php esc_html_e( 'Style 2' , 'docfi-core' ); ?></option>
			</select>
		</p>
