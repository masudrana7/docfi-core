...
class RT_Team extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Team', 'docfi-core' );
	...
	public function rt_fields(){
		$terms = get_terms( array( 'taxonomy' => 'docfi_team_category', 'fields' => 'id=>name' ) );
		...
		$fields = array(
			...
			array(
				...
				'options' => array(
					'style1' => esc_html__( 'Team Grid 1', 'docfi-core' ),
					'style2' => esc_html__( 'Team Grid 2', 'docfi-core' ),
					'style3' => esc_html__( 'Team Grid 3', 'docfi-core' ),
					'style4' => esc_html__( 'Team Grid 4', 'docfi-core' ),
					'style8' => esc_html__( 'Team Grid 5', 'docfi-core' ),
					'style5' => esc_html__( 'Team Slider 1', 'docfi-core' ),
					'style6' => esc_html__( 'Team Slider 2', 'docfi-core' ),
					'style7' => esc_html__( 'Team Slider 3', 'docfi-core' ),
					'style9' => esc_html__( 'Team Slider 4', 'docfi-core' ),
				),
				'default' => 'style1',
			),
			array(
			...
			array(
				...
				'default' => esc_html__( 'More Teams', 'docfi-core' ),
			...
			array(
				...
				'label'       => esc_html__( 'Designation Display', 'docfi-core' ),
				'label_on'    => esc_html__( 'On', 'docfi-core' ),
				'label_off'   => esc_html__( 'Off', 'docfi-core' ),
				'default'     => 'yes',
				'description' => esc_html__( 'Show or Hide Designation. Default: On', 'docfi-core' ),
			),
			array(
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'social_display',
				'label'       => esc_html__( 'Social Media Display', 'docfi-core' ),
				'label_on'    => esc_html__( 'On', 'docfi-core' ),
				'label_off'   => esc_html__( 'Off', 'docfi-core' ),
				'default'     => 'yes',
				'description' => esc_html__( 'Show or Hide Social Medias. Default: On', 'docfi-core' ),
			),
			array(
	            ...
	            'size_units' => [ 'px', '%', 'em' ],
	            'id'      => 'social_radius',
	            'label'   => __( 'Social Radius', 'docfi-core' ),                 
	            'selectors' => array(
			...
			array(
				...
				'id'      => 'box_radius',
				'mode'    => 'responsive',
				'label'   => esc_html__( 'Box Radius', 'docfi-core' ),
				'size_units' => [ 'px', '%' ],
				'selectors' => [
			...
			array(
	            ...
	            'size_units' => [ 'px', '%', 'em' ],
	            'id'      => 'content_radius',
	            'label'   => __( 'Content Radius', 'docfi-core' ),                 
	            'selectors' => array(
	        ...
	        array(
				'type'    => Controls_Manager::COLOR,
				'id'      => 'vactor_color',
				'label'   => esc_html__( 'Vactor Color', 'docfi-core' ),
				'default' => '',
				'selectors' => array(
			...
			array(
				...
				'options' => array(
					...
					'bottom-center' 	=> esc_html__( 'Bottom Center', 'docfi-core' ),
				),
				'default' => 'default',
