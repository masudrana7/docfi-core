...
class Docs_Group_listContent extends Custom_Widget_Base {

    public function __construct( $data = [], $args = null ){
        $this->rt_name = esc_html__( 'Docs Group List Content', 'docfi-core' );
        $this->rt_base = 'rt-docs-group-list-content';
    ...
    protected function render() {
		...
		$template = 'docs-group-list-content';
