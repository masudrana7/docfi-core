...
class Docs_Group_Single extends Custom_Widget_Base {

    public function __construct( $data = [], $args = null ){
        $this->rt_name = esc_html__( 'Docs Group Single', 'docfi-core' );
        $this->rt_base = 'rt-docs-group-single';
