...
<div class="rt-testimonial-default testimonial-multi-layout-2 rt-swiper-nav testimonial-slider-<?php echo esc_attr( $data['layout'] );?> <?php echo esc_attr( $data['nav_position'] ) ?> docfi-horizontal-slider">
                ...
                <div class="rt-item has-animation">
                    <div class="item-content" <?php if( $testimonial['item_color'] ) { ?> style="background-color: <?php echo esc_attr( $testimonial['item_color'] ); ?>" <?php } ?>>
                        <?php if( $data['quote_display'] == 'yes' ) { ?>
                            <span class="tquote"><i class="icon-docfi-quote-left"></i></span>
                        <?php } ?>                	
