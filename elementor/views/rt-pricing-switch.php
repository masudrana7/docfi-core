                    ...
                    <div class="rt-price-tab-box">
                        <div class="price-header">
                            ...
                            <h4 class="rt-price">
                                <?php if( !empty( $feature_list['offer_price'] ) ) { ?>
                                    <del><?php echo esc_html__( 'Regularly', 'docfi-core' ); ?> <?php echo wp_kses_post( $feature_list['price'] );?></del>
                            ...
                            ?>
                            <?php if( $feature_list['offer_price'] ) { ?><div class="save-price"><?php echo esc_html__( 'Save', 'docfi-core' ); ?> <?php echo floor($discounted_price); ?>%</div><?php } ?>
                        </div>
                        ...
                        <div class="rt-price-button">
                            <a <?php echo $attr; ?> class="button-style-2 btn-common">
                                <?php echo esc_html( $feature_list['buttontext'] );?><i class="icon-docfi-right-arrow"></i>
                            </a>
                        </div>      
                    </div>
                </div>
                        ...
                        <div class="price-header">
                            ...
                            <h4 class="rt-price">
                                <?php if( !empty( $feature_list2['offer_price2'] ) ) { ?>
                                    <del><?php echo esc_html__( 'Regularly', 'docfi-core' ); ?> <?php echo wp_kses_post( $feature_list2['price2'] );?></del>
                            ...
                            ?>
                            <?php if( $feature_list2['offer_price2'] ) { ?><div class="save-price"><?php echo esc_html__( 'Save', 'docfi-core' ); ?> <?php echo floor($discounted_price2); ?>%</div><?php } ?>
                        </div>
                        <div class="rt-features"><?php echo wp_kses_post( $feature_list2['text2'] ); ?></div>  
                        <div class="rt-price-button">
                            <a <?php echo $attr2; ?> class="button-style-2 btn-common">
                                <?php echo esc_html( $feature_list2['buttontext2'] );?><i class="icon-docfi-right-arrow"></i>
                            </a>
                        </div>      
                    </div>
                </div>
