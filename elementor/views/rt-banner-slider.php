                        ...
                        <div class="container">
                            <div class="slider-content">
                                ...
                                <div class="slider-btn-area">
                                    <a class="button-style-4 btn-common" href="<?php echo esc_url( $banner['button_url'] ); ?>"><?php echo wp_kses( $banner['button_text'], 'alltext_allow' ); ?><i class="icon-docfi-right-arrow"></i></a>
                                </div>
                                <?php } ?>
                            </div>
                        </div>
