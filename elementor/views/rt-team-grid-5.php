...
<div class="rt-team-default rt-team-multi-layout-5 team-grid-<?php echo esc_attr( $data['style'] );?>">
						...
						<div class="team-content-wrap">
							...
							<?php if ( !empty( $socials ) && $data['social_display']  == 'yes' ) { ?>
								<ul class="team-social">
									<li class="social-item"><a href="#" class="social-hover-icon social-link" aria-label="Social Share"><i class="icon-docfi-share"></i></a>
	...
	<?php if ( $data['more_button'] == 'show' ) { ?>
		...
		<div class="team-button"><a class="button-style-2 btn-common" href="<?php echo esc_url( $data['see_button_link'] );?>"><?php echo esc_html( $data['see_button_text'] );?><i class="icon-docfi-right-arrow"></i></a></div>
		<?php } ?>
	<?php } else { ?>
