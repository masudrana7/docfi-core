...
?>
<div class="rt-portfolio-default rt-portfolio-multi-layout-6 portfolio-grid-<?php echo esc_attr( $data['style'] );?>">
						...
						<?php
							if ( has_post_thumbnail() ){
								...
								if ( !empty( DocfiTheme::$options['no_preview_image']['id'] ) ) {
									...
									echo '<img class="wp-post-image" src="' . DocfiTheme_Helper::get_img( 'noimage_960X520.jpg' ) . '" alt="'.get_the_title().'" loading="lazy" >';
								}
							}
						?>
					</a>			
				</div>
				<div class="portfolio-content port-hover-effect">
